...
DiskFiles = [
	...
	"content/BRAZIL2.MBM",
	"content/NOLIMIT.MBM",
	"content/OXYGENE4.MBM",
	"content/ODYSSEY.MBM",
	"content/RUNEMAST.MBM",
	"content/GHOSTBUS.MBM",
	"content/FRAY.MBM"
];
AddSources = [ "mbm_opll.c" ];
...
EmulMSXMusic = true;				//-- Add MSX-Music extension (boolean)
EmulMSXAudio = false;				//-- YM2413 player: do not steal a slot with Y8950
